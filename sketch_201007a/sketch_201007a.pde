...
//Global Variables
color circleblack = #0D0D0C, purple=#E503FF, black=#0D0D0C, red=#FA0810, green=#0C931A;
color orange=#FF8E03;
...
void setup() {
  ...
  button2Width = width * 0.5/3 * 1/2;
  button2Height = height * 1/3 * 1/2;
  //
  //Button to illustrate arithmetic
  button3X = width * 7/15; //Section 3, subsection 2: denominator is 3*5, numerator is counted
  button3Y = height * 13/16; //Section 3, subsection 4: denominator is 3*5, numerator is counted
  button3Width = width * 2/3 * 3/5;
  button3Height = height * 1/3 * 1/5;

  //Last Button to Test Concept of Buttons
  button4X = width*11/15; 
  button4Y = height*2/15; 
